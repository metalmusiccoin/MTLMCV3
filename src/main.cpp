...
int64 nChainStartTime = 1424750293;
...
const string strMessageMagic = "MetalMusicCoin3 Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
    {
        nSubsidy = 18000000 * COIN;  // 18 Million coins
        return nSubsidy + nFees;
    }

    // Subsidy is cut in half every 2,628,000 blocks, which will occur approximately every 5 years
    nSubsidy >>= (nHeight / 2628000);
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in MetalMusicCoin3
    bool fStrictPayToScriptHash = true; // Always active in MetalMusicCoin3
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MetalMusicCoin3", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "February 24, 2015. Metal Music Coin Version 3.0 Has Been Created. 1424750293";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1424750293;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1944898;
        ...
        assert(block.hashMerkleRoot == uint256("43fef7045c11bf93bb1529a4a3fce3cf6e3100e384f9f6e49f70c6a174c802ad"));
